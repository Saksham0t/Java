...
class FDaccount extends Account {
    ...
    double calculateInterest(double amount)throws InvalidAmountException,  InvalidAgeException, InvalidDaysException {
...
class RDaccount extends Account {
    ...
    double
    calculateInterest(double Ramount) throws InvalidAmountException, InvalidMonthsException,InvalidAgeException {
